...
export default function Resultat1() {
  ...
  return (
    <section className="w-full">
      <BannerResultat1 dataset="resultats-2" />
      <HeroBlockResultats1 dataset="resultats-2" />
      <StoryResultats1 dataset="resultats-2" />
      <div className="container mx-auto px-4 pb-12">
        <div className="flex flex-col gap-6 text-center">
          <ChartAreaInteractive1 dataset="resultats-2" />
          <ChartAreaInteractive2 dataset="resultats-2" />
          <TargetsTable dataset="resultats-2" />
        </div>
      </div>
      <HeroLabSection>
