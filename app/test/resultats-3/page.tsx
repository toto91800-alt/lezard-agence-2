...
export default function Resultat1() {
  ...
  return (
    <section className="w-full">
      <BannerResultat1 dataset="resultats-3" />
      <HeroBlockResultats1 dataset="resultats-3" />
      <StoryResultats1 dataset="resultats-3" />
      <div className="container mx-auto px-4 pb-12">
        <div className="flex flex-col gap-6 text-center">
          <ChartAreaInteractive1 dataset="resultats-3" />
          <ChartAreaInteractive2 dataset="resultats-3" />
          <TargetsTable dataset="resultats-3" />
        </div>
      </div>
      <HeroLabSection>
