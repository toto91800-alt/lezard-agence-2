...
type CardResultatProps = {
  ...
  linkButton: string; // 👈 lien pour ButtonShow
};
...
export default function CardResultat({
  ...
  return (
    <div className="relative w-full max-w-xl p-4 border rounded-2xl shadow-md bg-white flex flex-col">
      ...
      {/* Bio */}
      {bio && (
        <p className="mt-3 whitespace-pre-line text-[15px] leading-snug text-gray-800">
          {bio}
        </p>
      )}
      ...
      {/* Bouton Show avec lien indépendant */}
      <div className="mt-4">
