// components/trial/ButtonDemo.tsx
"use client";
    ...
    <>
      ...
      <style>{`
        ...
        .btn-demo:hover::after{
          animation: btnDemoShine 900ms ease-out forwards;
        }
        @keyframes btnDemoShine{
          to { transform: translateX(200%); }
        }

        /* Icône: tilt + léger glow au hover */
        .btn-demo .icon-wrap { transition: transform .2s ease, filter .2s ease; color:#fff; }
